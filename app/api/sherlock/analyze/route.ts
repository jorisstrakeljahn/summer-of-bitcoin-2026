/**
 * POST /api/sherlock/analyze — Accepts blk.dat, rev.dat, and xor.dat via FormData,
...
import { invalidateReport } from "@/lib/sherlock/report-cache";
import { invalidateBlockData } from "@/lib/sherlock/block-cache";

function fixturesDir(): string {
  return join(process.cwd(), "challenge-3-sherlock", "fixtures");
}

function outDir(): string {
  return join(process.cwd(), "challenge-3-sherlock", "out");
}
