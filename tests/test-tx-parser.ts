 ...
 *
 * Why: Correct parsing of raw Bitcoin transactions is the foundation.
 * Tests size/weight/vbytes (BIP141), SegWit detection, and error handling.
 */
...
describe("TX parser: fixture validation", () => {
...
// ---------------------------------------------------------------------------
// SegWit byte metrics (BIP141: witness vs non-witness)
// ---------------------------------------------------------------------------

describe("TX parser: SegWit byte metrics", () => {
  test("segwit: nonWitness + witness = total size", () => {
    ...
    assert(p.witnessBytes > 0, "segwit tx must have witness bytes > 0");
  });

  test("legacy: witness = 0, nonWitness = total size", () => {
...
describe("TX parser: error handling", () => {
